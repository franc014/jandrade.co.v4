...
For the close button, the inverse of this logic is applied. Please, visit the branch that corresponds to this refactoring to check all the code details.

This way, we've arrived at the end of our refactoring. But to enhance our application demo, even further, in the next post we will add an important feature related to motion. Stay tuned!